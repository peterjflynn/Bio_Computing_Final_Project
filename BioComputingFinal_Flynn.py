...
# -out specifies what you want the output to be called
# 
# Since tBlastx takes several hours to run for this job, I just provided the end result of the tblastx (tblastx.xml) and do not have this running in this script (but provided the code below).

# In[ ]:

#run tBlastx
#import os 
#cmd = "tblastx -query merged_viruses.fna -db genome_db -evalue 1 -culling_limit 1 -outfmt 5 -out tblastx_hits.xml"
#os.system(cmd)


# I have provided the tblastx.xml hits file that would have been produced from this tblastx.
# 
